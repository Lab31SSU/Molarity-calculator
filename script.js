...
function setResultType(type, target) {
    resultType = type;
                ...
                <div class="result-item">
                    ...
                    <div class="format-row">
                        ...
                        <div class="format-item plain-format"
                             onclick="copyToClipboard(this.textContent, this)"
                             id="${ids[i]}_plain">0</div>
                        <div class="format-item latex-format"
                             onclick="copyToClipboard(this.textContent, this)"
                             id="${ids[i]}_latex">$0$</div>
                    </div>
                </div>
            `).join('')}
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.toggle-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            setResultType(type, this);
        });
    });

    document.getElementById('concentration').addEventListener('input', calculate);
    document.getElementById('molarMassInput').addEventListener('input', updateMolarMass);
